...
*/
        ...
        adapter = new ContentAdapter(this.getActivity(),listData);
...
*/
    ...
    private ArrayList<ListItem> getListData() throws Exception {
        ...
        try {
            String ketan = asyncHttpPost1.execute(Links.commonUrl + "/scripts/list.php").get();
...
*/
            ...
            upvt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    System.out.println("the flag in button is :  "+f);
                    ...
                    /*AsyncHttpPost2 async = new AsyncHttpPost2();
                    try {
                        String s = async.execute(uploadURL+"upvote.php",postid,uname).get();

                        if(s.equalsIgnoreCase("You have already upvoted this post")){
                            System.out.println("post already upvoted:::: "+flags);
                            flags = 0;
                            ...
                            System.out.println("post upvoted:::: "+flags);
                            flags =1;
    ...
    private int giveUpvote(String postid, String username) {
        ...
        System.out.println("async upload flag:   "+ flags);
        return flags;
    }

    /*public static class AsyncHttpPost2 extends AsyncTask<String, String, String> {
        @Override
        protected String doInBackground(String... params) {
            try {
                URL url = new URL(params[0]);
                String postidx = params[1];
                String unamex = params[2];
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setRequestMethod("POST");
                conn.setDoInput(true);
                conn.setDoOutput(true);
                ...
                String send = "postid="+postidx+"&username"+unamex;
