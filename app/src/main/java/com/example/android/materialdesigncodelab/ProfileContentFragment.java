...
public class ProfileContentFragment extends Fragment {
    ...
    public static String userURL = Links.commonUrl + "/scripts/userProfile.php";
    ...
    private ArrayList<ListItem> getUserData() throws Exception {
